...
const SimpleToast = ({ options, show, onHide, defaultOpts }) => {
  ...
  const acceptButtonText = options?.acceptButtonText ?? defaultOpts?.acceptButtonText ?? ''; // added 
  const rejectButtonText = options?.rejectButtonText ?? defaultOpts?.rejectButtonText ?? '';  // added
